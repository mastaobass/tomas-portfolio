...
import heroImage from "../../assets/trust-score-hero.png";
import reasonCodesImage from "../../assets/reason-codes.png";
import queueImage from "../../assets/trust-score-queue.png";
...
The original Figma file is Equifax IP. The public kit is the same product slice rebuilt: a ten-row review queue that opens the Payments Fraud case. The score explainer lives on that case, not on the table. The constraints did not change. Weights stay hidden. Reasons are pre-scripted. The visual baseline is pinned at 80.0.

<Figure
  src={queueImage}
  alt="Reconstructed payment review queue with ten transactions, trust scores, and decision statuses"
  label="Reconstruction — review queue"
  caption="Ten reconstructed payments. Open a row to work the payments-fraud case. This is the surface analysts lived in, not a component gallery."
/>
...
Open Northwind or Harbor in the [live console](https://mastaobass.github.io/trust-score-ds/console/). Source is on [GitHub](https://github.com/mastaobass/trust-score-ds). The component kit is still in [Storybook](https://mastaobass.github.io/trust-score-ds/?path=/story/compositions-casedetail--northwind).
